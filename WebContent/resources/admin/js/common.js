...
var messages = {
	...
	"admin.dialog.deleteConfirm": "您确定要执行此项操作吗？",
	"admin.dialog.deleteChoise":"请先选择要操作的数据",
...
//消息内容 ，方法函数
function showTips(message,eventhandler){
	 $.dialog({
...
function showSuccess(message,eventhandler){
	 $.dialog({
